...
(you will see no output if there are no error response codes)
...
In order to be able to see immediate results of the Circuit Breaker activation, configure it with the following values:
- TCP settings
  - MAX CONNECTIONS: 1
